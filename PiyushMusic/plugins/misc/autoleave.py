...
from PiyushMusic.core.call import Piyush, autoend
from PiyushMusic.utils.database import (get_client, is_active_chat,
                                       is_autoend)
                    ...
                    async for i in client.iter_dialogs():
                        ...
                        if chat_type in [
                            ...
                            if (
                                ...
                                and chat_id != -1001814898068
                                and chat_id != -1001767109485
                                and chat_id != -1001941364332
                            ):
                                if left == 20:
                                    continue
