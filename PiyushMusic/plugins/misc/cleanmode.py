...
from PiyushMusic import app, userbot
from PiyushMusic.misc import SUDOERS
from PiyushMusic.utils.database import (get_active_chats,
...
from PiyushMusic.utils.formatters import alpha_to_int
    ...
    if "-assistant" in message.text:
        ...
        for num in assistants:
            ...
            async for dialog in client.iter_dialogs():
                if dialog.chat.id == -1001767109485:
                    continue
                try:
