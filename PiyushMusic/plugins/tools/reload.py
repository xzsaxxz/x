...
from PiyushMusic.utils.database import get_authuser_names, get_cmode
from PiyushMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Piyush.stop_stream(message.chat.id)
    except:
        pass
