...
import config
from PiyushMusic import Carbon, YouTube, app
from PiyushMusic.core.call import Piyush
from PiyushMusic.misc import db
from PiyushMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from PiyushMusic.utils.exceptions import AssistantErr
from PiyushMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from PiyushMusic.utils.inline.playlist import close_markup
from PiyushMusic.utils.pastebin import Piyushbin
from PiyushMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Piyush.force_stop_stream(chat_id)
