...
TEMP_MONGODB = "mongodb+srv://PiyushDatabase:PiyushDatabase@piyushdatabase.lofrtnf.mongodb.net/?retryWrites=true&w=majority"


if config.MONGO_DB_URI is None:
    LOGGER(__name__).warning(
        "No MONGO DB URL found.. Your Bot will work on Piyush's Database"
    )
    temp_client = Client(
        name="Yukki",
